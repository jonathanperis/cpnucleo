...
{
    /// <inheritdoc />
    public partial class InitiaDblMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountHours = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Assignments_Workflows_WorkflowId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssignmentImpediments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssignmentImpediments_Assignments_AssignmentId",
                        column: x => x.AssignmentId,
                        principalTable: "Assignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentImpediments_Impediments_ImpedimentId",
                        column: x => x.ImpedimentId,
                        principalTable: "Impediments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignmentImpediments_AssignmentId",
                table: "AssignmentImpediments",
                column: "AssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentImpediments_CreatedAt",
                table: "AssignmentImpediments",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentImpediments_ImpedimentId",
                table: "AssignmentImpediments",
                column: "ImpedimentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_WorkflowId",
                table: "Assignments",
                column: "WorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignmentTypes_CreatedAt",
                table: "AssignmentTypes",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Impediments_CreatedAt",
                table: "Impediments",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAssignments_CreatedAt",
                table: "UserAssignments",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProjects_CreatedAt",
                table: "UserProjects",
                column: "CreatedAt");
