...
public sealed class UpdateAssignmentCommandValidator : AbstractValidator<UpdateAssignmentCommand>
{
    public UpdateAssignmentCommandValidator()
    {
        ...
        RuleFor(x => x.AmountHours).GreaterThan((byte)0).WithMessage("Amount hours is required.");
        ...
        RuleFor(x => x.AssignmentTypeId).NotEmpty().WithMessage("AssignmentTypeId is required.");
    }
}
