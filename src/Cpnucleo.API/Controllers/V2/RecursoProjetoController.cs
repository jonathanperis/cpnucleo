...
namespace Cpnucleo.API.Controllers.V2
{
    ...
    public class RecursoProjetoController : ControllerBase
    {
        ...
        public async Task<ActionResult<CreateRecursoProjetoResponse>> Post([FromBody] CreateRecursoProjetoComand request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<UpdateRecursoProjetoResponse>> Put(Guid id, [FromBody] UpdateRecursoProjetoComand request)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        {
            RemoveRecursoProjetoResponse result = await _mediator.Send(new RemoveRecursoProjetoComand
            {
                Id = id
            });
