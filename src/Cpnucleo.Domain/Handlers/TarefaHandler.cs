using Cpnucleo.Domain.Commands.Requests.Tarefa;
using Cpnucleo.Domain.Commands.Responses.Tarefa;
using Cpnucleo.Domain.Entities;
using Cpnucleo.Domain.Queries.Requests.Tarefa;
...
namespace Cpnucleo.Domain.Handlers
{
        ...
        IRequestHandler<UpdateByWorkflowCommand, UpdateByWorkflowResponse>
    {
        ...
        public TarefaHandler(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<CreateTarefaResponse> Handle(CreateTarefaComand request, CancellationToken cancellationToken)
        {
            ...
            result.Tarefa = await _unitOfWork.TarefaRepository.AddAsync(request.Tarefa);
        ...
        public async Task<GetTarefaResponse> Handle(GetTarefaQuery request, CancellationToken cancellationToken)
        {
            ...
            result.Tarefa = await _unitOfWork.TarefaRepository.GetAsync(request.Id);
            result.Status = OperationResult.Success;
        ...
        public async Task<ListTarefaResponse> Handle(ListTarefaQuery request, CancellationToken cancellationToken)
        {
            ...
            result.Tarefas = await _unitOfWork.TarefaRepository.AllAsync(request.GetDependencies);
            result.Status = OperationResult.Success;
        ...
        public async Task<RemoveTarefaResponse> Handle(RemoveTarefaComand request, CancellationToken cancellationToken)
        {
            ...
            Entities.Tarefa obj = await _unitOfWork.TarefaRepository.GetAsync(request.Id);
        ...
        public async Task<UpdateTarefaResponse> Handle(UpdateTarefaComand request, CancellationToken cancellationToken)
        {
            ...
            _unitOfWork.TarefaRepository.Update(request.Tarefa);
        ...
        public async Task<GetByRecursoResponse> Handle(GetByRecursoQuery request, CancellationToken cancellationToken)
        {
            ...
            result.Tarefas = await _unitOfWork.TarefaRepository.GetByRecursoAsync(request.IdRecurso);
            result.Status = OperationResult.Success;
        ...
        public async Task<UpdateByWorkflowResponse> Handle(UpdateByWorkflowCommand request, CancellationToken cancellationToken)
        {
            ...
            tarefa.Workflow = request.Workflow;
        ...
        private async Task PreencherDadosAdicionaisAsync(IEnumerable<Tarefa> lista)
        {
