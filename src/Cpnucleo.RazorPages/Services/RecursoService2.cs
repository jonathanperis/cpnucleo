...
{
    internal class RecursoService2 : IRecursoService2
    {
        private readonly IHttpService _httpService;

        private const string actionRoute = "recurso";
        
        public RecursoService2(IHttpService httpService)
        {
        ...
        {
            return await _httpService.PostAsync<RecursoViewModel>($"{actionRoute}/autenticar", "", new { Username = username, Password = password });
        }
    }
}