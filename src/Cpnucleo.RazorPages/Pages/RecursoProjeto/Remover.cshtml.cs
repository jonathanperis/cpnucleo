...
namespace Cpnucleo.RazorPages.Pages.RecursoProjeto
{
    ...
    public class RemoverModel : PageModel
    {
        ...
        public RemoverModel(IRecursoProjetoAppService recursoProjetoAppService) => _recursoProjetoAppService = recursoProjetoAppService;

        [BindProperty]
        public RecursoProjetoViewModel RecursoProjeto { get; set; }

        public IActionResult OnGet(Guid idRecursoProjeto)
        {
            RecursoProjeto = _recursoProjetoAppService.Consultar(idRecursoProjeto);
