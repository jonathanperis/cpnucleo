...
public class CreateUserProjectCommandHandlerTest
{
    ...
    public async Task Handle_ShouldReturnSuccess_WhenUserProjectIsCreatedSuccessfully()
    {
        ...
        var command = new CreateUserProjectCommand(BaseEntity.GetNewId(), BaseEntity.GetNewId());
    ...
    {
        // Arrange
        var command = new CreateUserProjectCommand(Guid.Empty, BaseEntity.GetNewId());
    ...
    {
        // Arrange
        var command = new CreateUserProjectCommand(BaseEntity.GetNewId(), Guid.Empty);
        var validator = new CreateUserProjectCommandValidator();
