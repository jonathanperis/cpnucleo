...
public class CreateAssignmentCommandHandlerTest
{
    ...
    public async Task Handle_ShouldReturnSuccess_WhenAssignmentIsCreatedSuccessfully()
    {
        ...
        var command = new CreateAssignmentCommand("Test Assignment", "Assignment Description", DateTime.UtcNow, DateTime.UtcNow.AddDays(1), 2, Ulid.NewUlid(), Ulid.NewUlid(), Ulid.NewUlid(), Ulid.NewUlid());
    ...
    {
        // Arrange
        var command = new CreateAssignmentCommand(string.Empty, "Assignment Description", DateTime.UtcNow, DateTime.UtcNow.AddDays(1), 2, Ulid.NewUlid(), Ulid.NewUlid(), Ulid.NewUlid(), Ulid.NewUlid());
